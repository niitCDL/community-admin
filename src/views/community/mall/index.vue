<template>
	<el-card>
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item>
				<el-input v-model="state.queryForm.realName" clearable placeholder="店家" style="width: 150px"></el-input>
			</el-form-item>
			<el-form-item>
			...
			<el-form-item v-auth="'sys:house:import'">
				<el-upload :action="uploadMallExceUrl" :before-upload="beforeUpload" :on-success="handleSuccess" :show-file-list="false">
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="realName" label="店家法人" header-align="center" align="center"></el-table-column>
...
const uploadMallExceUrl = constant.apiUrl + '/sys/mall/import?accessToken=' + cache.getToken()
const downloadExcel = () => {
	//exportBuilding()
	const url = constant.apiUrl + '/sys/mall/export?accessToken=' + cache.getToken()
	axios
		.get(url, { responseType: 'blob' })
		.then(response => {
			const filename = '商铺信息.xlsx' // 下载文件的默认文件名
