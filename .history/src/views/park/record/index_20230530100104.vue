<template>
	<el-card>
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			<el-form-item>
				<el-input v-model="state.queryForm.parkName" placeholder="停车场名称"></el-input>
			</el-form-item>
			<el-form-item>
				<el-input v-model="state.queryForm.licence" placeholder="车牌号"></el-input>
			</el-form-item>
			<el-form-item>
				<el-input v-model="state.queryForm.doorName" placeholder="设备名称"></el-input>
			</el-form-item>
			<el-form-item prop="type">
				<el-select v-model="state.queryForm.type" placeholder="车辆类型">
					<el-option :label="0" :value="0">临时车辆</el-option>
					<el-option :label="1" :value="1">固定车辆</el-option>
				</el-select>
			</el-form-item>
			<el-form-item>
...
computed: {
    selectedTypeAsNumber() {
      // Convert selectedType (which is a string) to an integer
      return parseInt(this.selectedType);
    },
    selectedType: {
      get() {
        return this.state.queryForm.type;
      },
      set(value) {
        this.state.queryForm.type = value;
      },
    },
  },
