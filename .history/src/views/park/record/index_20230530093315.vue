<template>
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="carId" label="车辆id" header-align="center" align="center"></el-table-column>
			<el-table-column prop="parkId" label="停车场id" header-align="center" align="center"></el-table-column>
			<el-table-column prop="doorId" label="设备id" header-align="center" align="center"></el-table-column>
			...
			<el-table-column prop="type" label="车辆类型（0：临时车辆 1：固定车辆）" header-align="center" align="center"></el-table-column>
			...
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
				<template #default="scope">
					<el-button v-auth="'soft2242:record:update'" type="primary" link @click="addOrUpdateHandle(scope.row.id)">修改</el-button>
					<el-button v-auth="'soft2242:record:delete'" type="primary" link @click="deleteBatchHandle(scope.row.id)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		<el-pagination
...
const state: IHooksOptions = reactive({
	dataListUrl: '/soft2242/record/page',
	deleteUrl: '/soft2242/record',
	queryForm: {
		carId: '',
		doorId: '',
		type: ''
