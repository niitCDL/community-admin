<template>
	<el-card>
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			<el-form-item>
				<el-input v-model="state.queryForm.parkName" placeholder="车辆id"></el-input>
			</el-form-item>
			<el-form-item>
				<el-input v-model="state.queryForm.licence" placeholder="设备id"></el-input>
			</el-form-item>
			<el-form-item>
				<el-input v-model="state.queryForm.doorName" placeholder="车辆类型（0：临时车辆 1：固定车辆）"></el-input>
			</el-form-item>
			<el-form-item prop="type" label="所属停车场">
