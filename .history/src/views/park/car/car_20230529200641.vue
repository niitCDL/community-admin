<template>
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="deadline" label="保险截止日期" header-align="center" align="center" width="80"></el-table-column>
			<el-table-column prop="annualTime" label="年审日期" header-align="center" align="center" width="80"></el-table-column>
