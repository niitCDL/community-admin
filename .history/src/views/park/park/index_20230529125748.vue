<template>
	<el-card>
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item>
				<el-button v-auth="'admin-park:park:save'" type="primary" @click="addOrUpdateHandle()">新增</el-button>
			</el-form-item>
			<el-form-item>
				<el-button v-auth="'admin-park:park:delete'" type="danger" @click="deleteBatchHandle()">删除</el-button>
			</el-form-item>
		</el-form>
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="status" label="状态（0：开启 1：关闭）" header-align="center" align="center"></el-table-column>
			<el-table-column prop="parkImg" label="停车场图" header-align="center" align="center"></el-table-column>
			<el-table-column prop="content" label="备注" header-align="center" align="center"></el-table-column>
			<el-table-column prop="price" label="单价（按小时收费）;10.00" header-align="center" align="center"></el-table-column>
			...
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
				<template #default="scope">
					<el-button v-auth="'admin-park:park:update'" type="primary" link @click="addOrUpdateHandle(scope.row.id)">修改</el-button>
					<el-button v-auth="'admin-park:park:delete'" type="primary" link @click="deleteBatchHandle(scope.row.id)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		<el-pagination
...
const state: IHooksOptions = reactive({
	dataListUrl: '/admin-park/park/page',
	deleteUrl: '/admin-park/park',
	queryForm: {
		parkName: ''
	}
})
