<template>
	<el-card>
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item>
				<el-select v-model="state.queryForm.parkName" placeholder="停车场名称" clearable style="width: 150px">
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="carportNumber" label="车位数量" header-align="center" align="center" width="100"></el-table-column>
