<template>
	<el-dialog v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false">
		<el-form ref="dataFormRef" :model="dataForm" :rules="dataRules" label-width="100px" @keyup.enter="submitHandle()">
				...
				<el-form-item label="状态（0：开启 1：关闭）" prop="status">
					<el-input v-model="dataForm.status" placeholder="状态（0：开启 1：关闭）"></el-input>
				</el-form-item>
...
import { useParkApi, useParkSubmitApi } from '@/api/admin-park/park'
