<template>
	<el-card>
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item>
				<el-input v-model="state.queryForm.carportNumber" placeholder="车位名称" clearable style="width: 150px"></el-input>
			</el-form-item>
			<el-form-item>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="carportName" label="车位名称" header-align="center" align="center"></el-table-column>
			...
			<el-table-column prop="status" label="车位状态" header-align="center" align="center"
