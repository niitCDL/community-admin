...
<template>
	...
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="platformId" label="社区ID" header-align="center" align="center"></el-table-column>
			<fast-table-column prop="platform" label="社区名字" dict-type="sms_platform"></fast-table-column>
			<el-table-column prop="mobile" label="社区地址" header-align="center" align="center"></el-table-column>
