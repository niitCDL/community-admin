	...
	<el-card>
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item v-auth="'sys:community:import'">
				<el-upload :action="constant.uploadCommunityExceUrl" :before-upload="beforeUpload" :on-success="handleSuccess" :show-file-list="false">
...
//导入
const uploadCommunityExceUrl = () => {
	const url = constant.apiUrl + '/sys/community/import?accessToken=' + cache.getToken()
}
