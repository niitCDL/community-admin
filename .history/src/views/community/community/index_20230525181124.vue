...
<template>
	...
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="id" label="社区ID" header-align="center" align="center"></el-table-column>
			...
			<el-table-column prop="communityImgs" label="社区图片" header-align="center" align="center" class="h-10">
				<template #default="scope">
					<img :src="scope.row.communityImgs" alt="图片" />
				</template>
			</el-table-column>
			<el-table-column prop="coverArea" label="社区面积" dict-type="success_fail"></el-table-column>
