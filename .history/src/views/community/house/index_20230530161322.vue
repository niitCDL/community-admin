	...
	<el-card>
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item v-auth="'sys:house:import'">
				<el-upload :action="uploadHouseExceUrl" :before-upload="beforeUpload" :on-success="handleSuccess" :show-file-list="false">
...
const uploadHouseExceUrl = constant.apiUrl + '/sys/house/import?accessToken=' + cache.getToken()
const downloadExcel = () => {
	//exportBuilding()
	const url = constant.apiUrl + '/sys/house/export?accessToken=' + cache.getToken()
	axios
