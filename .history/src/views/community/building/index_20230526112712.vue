<template>
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="id" label="楼宇ID" header-align="center" align="center"></el-table-column>
			...
			<el-table-column prop="units" label="手机号" header-align="center" align="center"></el-table-column>
			<el-table-column prop="usedArea" label="邮箱" header-align="center" align="center"></el-table-column>
			<el-table-column prop="content" label="所属机构" header-align="center" align="center"></el-table-column>
