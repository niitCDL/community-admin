	...
	<el-dialog v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" draggable>
		<el-form ref="dataFormRef" :model="dataForm" :rules="dataRules" label-width="120px" @keyup.enter="submitHandle()">
			<el-form-item prop="buildingName" label="楼宇名称">
				<el-input v-model="dataForm.buildingName" placeholder="所在单元"></el-input>
			</el-form-item>
			...
			<el-form-item prop="usedArea" label="占地面积">
				<fast-radio-group v-model="dataForm.usedArea"></fast-radio-group>
			</el-form-item>
...
// import { useOrgListApi } from '@/api/sys/orgs'
 import { useUserApi, useUserSubmitApi } from '@/api/building/building'
